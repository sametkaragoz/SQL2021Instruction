...
------------------------------------------------------------------------------*/ 
    ...
    FROM sirketler s                              --id sp den geldiði için sadece þirkette olan 100 id null oldu,bunu görmek için id ekledim yoksa þart deðil
...
/* -----------------------------------------------------------------------------
  ...
  siparis_id ve siparis_tarihleri listeleyen bir sorgu yaziniz.
------------------------------------------------------------------------------*/   
    select sirket_isim,siparis_id,siparis_tarihi,sp.sirket_id,s.sirket_id --id ler opsiyonel, istersek yazdýrýrýz
   from sirketler s
...
------------------------------------------------------------------------------*/   
  ...
  ----ornekler   
   ...
   SELECT * FROM bolumler;
    ...
    INSERT INTO personel VALUES (7566,'MUZAFFER','MUDUR',7839,'02.APR.1981',2975,20);
    INSERT INTO personel VALUES (7654,'MUHAMMET','SATIS',7698,'28.SEP.1981',1250,30);
    INSERT INTO personel VALUES (7698,'EMINE','MUDUR',7839,'01.MAY.1981',2850,30);
    INSERT INTO personel VALUES (7782,'HARUN','MUDUR',7839,'09.JUN.1981', 2450,10);
    ...
    INSERT INTO personel VALUES (7844,'DUYGU','SATIS',7698,'08.SEP.1981',1500,30);
    INSERT INTO personel VALUES (7876,'ALI','KATIP',7788,'13.JUL.1987',1100,20);
    INSERT INTO personel VALUES (7900,'MERVE','KATIP',7698,'03.DEC.1981',950,30);
    INSERT INTO personel VALUES (7902,'NAZLI','ANALIST',7566,'03.DEC.1981',3000,20);
